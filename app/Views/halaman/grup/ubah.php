    ...
    <div class="card-body">
      ...
      <?= form_open(route_to('grupUbahAction', esc($grup['grup_id']))) ?>
        ...
        <div class="form-floating mb-2">
          <input type="text" name="grup_nama" id="floatingNamaInput" class="form-control" placeholder="Nama Grup" required maxlength="100" value="<?= old('grup_nama') !== null ? old('grup_nama') : esc($grup['grup_nama']) ?>">
          <label for="floatingNamaInput">Nama Grup</label>
        </div>

        <!-- Keterangan Grup -->
        <div class="form-floating mb-2">
          <input type="text" name="grup_keterangan" id="floatingKeteranganInput" class="form-control" placeholder="Keterangan Grup" required maxlength="100" value="<?= old('grup_keterangan') !== null ? old('grup_keterangan') : esc($grup['grup_keterangan']) ?>">
