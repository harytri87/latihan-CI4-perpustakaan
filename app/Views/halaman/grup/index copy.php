                ...
                <tr>
                  ...
                  <td class="text-center" style="width: 21%;">
                    <abbr title="ubah data">
                      <a href="<?= route_to('grupRincian', esc($grup_item['grup_id'])) ?>" class="btn btn-warning btn-sm"><i class="bi bi-pencil-fill"></i></a>
                    </abbr>

                    <abbr title="hapus data">
                      <!-- Button trigger modal -->
                      <a href="<?= route_to('grupHapus', esc($grup_item['grup_id'])) ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a>
                    </abbr>

                    <form action="<?= route_to('grupHapus', esc($grup_item['grup_id'])) ?>" method="delete">
                      <?= csrf_field() ?>
